...
## SEMPRE: alimentar a Swipe Library (o cérebro que compõe)
Ao terminar, **acrescente** o que extraiu em `swipe/observado.md` (1 bloco, no nicho certo) e registre 1 linha em `swipe/INDEX.md`. Formato do bloco: mecanismo, ângulo dominante, funil, oferta/preço, stack, gatilhos, **hooks observados (literais)**, fonte. É isso que faz o sistema ficar mais esperto a cada espionagem. NÃO promova nada pra `validado.md` (só o `analista-funil` promove, quando o teu dinheiro provar).
