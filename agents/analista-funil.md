...
## SEMPRE: promover vencedores pra Swipe Library (fechar o loop que compõe)
Quando um hook/ângulo/mecanismo/criativo **pagou de verdade** (confirmado na Cakto), **promova** pra `swipe/validado.md` no nicho certo — com o NÚMERO que provou (ex.: "ad4: 3 vendas, ROAS 2,22"). É isso que faz o `copy` começar do vencedor na próxima oferta, em vez do zero. Só promova o que o dinheiro confirmou (não o que o Meta/VTurb sugere).
